...
def main(args):
    ...
    wandb.init(project="HyperLPTN",
               config={'use_hypernet':args.use_hypernet,'lr':args.lr, 'max_ssim':0, 'max_psnr':0,'test_psnr':0,'test_ssim': 0, 'best_epoch':0, 'loss_weight':args.loss_weight, 'gan_type': args.gan_type}, allow_val_change=True)
    train_model(config)
