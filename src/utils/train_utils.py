...
class TrainEpoch(Epoch):
    def __init__(self, model, loss, metrics, optimizer, device="cuda", verbose=True, contrastive=False):
        super().__init__(
            model=model,
            loss=loss,
            metrics=metrics,
...
class ValidEpoch(Epoch):
    def __init__(self, model, loss, metrics, device="cuda", verbose=True, contrastive=False):
        super().__init__(
            model=model,
            loss=loss,
            metrics=metrics,
