...
if __name__ == '__main__':
    ...
    parser.add_argument('--nrb_low', type=int, required=False, default=5)
    parser.add_argument('--nrb_high', type=int, required=False, default=4)
    ...
    parser.add_argument('--model_path', type=str, required=False, default='../543.pth')
